...
function BookDetails() {
  ...
  const { books, setBooks, valueStar, setValueStar } = React.useContext(
    BookContext
  );
          ...
          <div className="divInnerBookDetails">
            <div className="pictureTitle">
              ...
              <div className="moreInfos">
                ...
                <p className="ByFor">
                  By:{" "}
                  <a>{author === undefined ? "Autor indefinido" : author}</a>
                </p>
            ...
            <div className="PagesBuyContainer">
              <p className="QuantityPages">
                {pageCount === undefined
                  ? "Numero de paginas indefinido"
                  : pageCount}{" "}
                Pages
              </p>
              <div className="BuyFavorite">
                <a className="myButton" href={urlBuy} target="_blank">
                  <p className="labelBuy">Buy</p>
                </a>
